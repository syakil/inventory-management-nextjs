  ...
  return (
    <div className={sidebarClassNames}>
        ...
        <div className="flex-grow mt-8">
          ...
          <SidebarLink href='/product' icon={Clipboard} label="Product" isCollapsed={isSidebarCollapsed} />
          <SidebarLink href='/user' icon={User} label="User" isCollapsed={isSidebarCollapsed} />
          <SidebarLink href='/setting' icon={SlidersHorizontal} label="Setting" isCollapsed={isSidebarCollapsed} />
        </div>

        {/* FOOTER */}
        <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
            <p className="text-center text-xs text-gray-500">&copy; 2024 Syakil</p>
        </div>
    </div>
  )
}
